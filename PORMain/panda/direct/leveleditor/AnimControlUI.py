...
class TimeSlider(wx.Window):
    ...
    def DrawTimeSlider(self,dc):
        ...
        if self.frameNum <= 20:
            ...
            for i in xrange(1,int((self.frameNum+1)/2)):
                temp = self.points[i-1][0][0]+2*self.unitWidth
                self.points.append(((temp,self.h),(temp,self.h-15)))
        
            for i in xrange(1,self.frameNum/2+1):
                self.numbers.append(self.sliderStartFrame-1+i*2)
        
            for i in xrange(int((self.frameNum+1)/2)):
                dc.DrawLine(self.points[i][0][0], self.points[i][0][1], self.points[i][1][0], self.points[i][1][1])
                
            for i in xrange(self.frameNum/2):   
                st = str(self.numbers[i])
                tw,th = dc.GetTextExtent(st)
                dc.DrawText(st, self.points[i][0][0]+2, 0.5)
            ...
            for i in xrange(1,int(self.frameNum/5)):
                temp = self.points[i-1][0][0]+5*self.unitWidth
                self.points.append(((temp,self.h),(temp,self.h-15)))
        
            for i in xrange(1,self.frameNum/5+1):
                self.numbers.append(self.sliderStartFrame-1+i*5)
        
            for i in xrange(int(self.frameNum/5)):
                dc.DrawLine(self.points[i][0][0], self.points[i][0][1], self.points[i][1][0], self.points[i][1][1])
                
            for i in xrange(self.frameNum/5):   
                st = str(self.numbers[i])
                tw,th = dc.GetTextExtent(st)
                dc.DrawText(st, self.points[i][0][0]+2, 0.5)
            ...
            for i in xrange(1,int(self.frameNum/10)):
                temp = self.points[i-1][0][0]+10*self.unitWidth
                self.points.append(((temp,self.h),(temp,self.h-15)))
        
            for i in xrange(1,self.frameNum/10+1):
                self.numbers.append(self.sliderStartFrame+i*10)
        
            for i in xrange(int(self.frameNum/10)):
                dc.DrawLine(self.points[i][0][0], self.points[i][0][1], self.points[i][1][0], self.points[i][1][1])
                
            for i in xrange(self.frameNum/10):   
                st = str(self.numbers[i])
                tw,th = dc.GetTextExtent(st)
                dc.DrawText(st, self.points[i][0][0]+2, 0.5)
            ...
            for i in xrange(1,int(self.frameNum/50)):
                temp = self.points[i-1][0][0]+50*self.unitWidth
                self.points.append(((temp,self.h),(temp,self.h-15)))
        
            for i in xrange(1,self.frameNum/50+1):
                self.numbers.append(self.sliderStartFrame-1+i*50)
        
            for i in xrange(int(self.frameNum/50)):
                dc.DrawLine(self.points[i][0][0], self.points[i][0][1], self.points[i][1][0], self.points[i][1][1])
                
            for i in xrange(self.frameNum/50):   
                st = str(self.numbers[i])
                tw,th = dc.GetTextExtent(st)
                dc.DrawText(st, self.points[i][0][0]+2, 0.5)
            ...
            for i in xrange(1,int(self.frameNum/100)):
                temp = self.points[i-1][0][0]+100*self.unitWidth
                self.points.append(((temp,self.h),(temp,self.h-15)))
        
            for i in xrange(1,self.frameNum/100+1):
                self.numbers.append(self.sliderStartFrame-1+i*100)
        
            for i in xrange(int(self.frameNum/100)):
                dc.DrawLine(self.points[i][0][0], self.points[i][0][1], self.points[i][1][0], self.points[i][1][1])
                
            for i in xrange(self.frameNum/100):   
                st = str(self.numbers[i])
                tw,th = dc.GetTextExtent(st)
                dc.DrawText(st, self.points[i][0][0]+2, 0.5)
            ...
            for i in xrange(1,int(self.frameNum/1000)):
                temp = self.points[i-1][0][0]+1000*self.unitWidth
                self.points.append(((temp,self.h),(temp,self.h-15)))
        
            for i in xrange(1,self.frameNum/1000+1):
                self.numbers.append(self.sliderStartFrame-1+i*1000)
        
            for i in xrange(int(self.frameNum/1000)):
                dc.DrawLine(self.points[i][0][0], self.points[i][0][1], self.points[i][1][0], self.points[i][1][1])
                
            for i in xrange(self.frameNum/1000):   
                st = str(self.numbers[i])
                tw,th = dc.GetTextExtent(st)
                dc.DrawText(st, self.points[i][0][0]+2, 0.5)
...
class AnimControlUI(wx.Dialog):
    ...
    def sortKey(self):
        for i in xrange(0, len(self.keys)-1):
            for j in xrange(i+1, len(self.keys)):
    ...
    def OnPreKeyFrame(self,evt):
        ...
        if self.curFrame <= self.keys[0] or self.curFrame > self.keys[len(self.keys)-1]:
            ...
            for i in xrange(1, len(self.keys)):
    ...
    def OnDeleteKey(self,evt):
        ...
        for j in self.editor.animMgr.keyFramesInfo.keys():
            for k in xrange(0,len(self.editor.animMgr.keyFramesInfo[j])):
