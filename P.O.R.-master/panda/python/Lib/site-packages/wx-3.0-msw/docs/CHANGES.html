...
<p>Fixed wxPython bug on OSX that was preventing the wx.App's virtual
methods related to handling App Events, like open-files or reopen-app,
from being handled correctly.</p>
<p>NOTE: It appears that wxPython applications on OSX will now always be
getting an initial Apple Event(s) sent to <cite>MacOpenFiles</cite> coresponding to
the name of the script and args on the python command-line.</p>
<p>Added patch #15142 which adds support for building with and using GTK3
as the wx platform.  Thanks kosenko!</p>
<p>Fixed the OSX Carbon build to actually use Carbon. (Because of a
change in defaults it was actually building the Cocoa build instead.)</p>
<p>Pythonized DataViewCtrl.HitTest.  It now takes just the Point parameter
...
use its IsOk method.)  For example:</p>
...
<p>The previous release managed to escape out into the wild before the
...
been in the last release.</p>
<p>Fixed &quot;wxPyHtmlWinTagHandler, no destructor found.&quot; error.</p>
</div>
...
<p>Turned on a workaround for a bug that caused crashes on Windows XP.
...
<a class="reference external" href="http://trac.wxwidgets.org/ticket/13116">http://trac.wxwidgets.org/ticket/13116</a></p>
<p>Fixed &quot;wxPyXmlSubclassFactory, no destructor found.&quot; error.</p>
<p>Some Pubsub and AGW updates.</p>
<p>Ignore some code in wxOSX that was preventing stock data format IDs
from being used with custom data objects. (See
<a class="reference external" href="https://groups.google.com/forum/#!topic/wx-dev/wFxevpvbhvQ/discussion">https://groups.google.com/forum/#!topic/wx-dev/wFxevpvbhvQ/discussion</a>)</p>
<p>Various other fixes and enhancements from wxWidgets.</p>
</div>
