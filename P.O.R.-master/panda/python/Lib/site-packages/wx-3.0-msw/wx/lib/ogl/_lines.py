...
class LineShape(Shape):
    ...
    def Initialise(self):
        ...
        if self._lineControlPoints:
            ...
            for i in xrange(1,len(self._lineControlPoints)):
    ...
    def Straighten(self, dc = None):
        ...
        for i in xrange(len(self._lineControlPoints) - 2):
    ...
    def HitTest(self, x, y):
        ...
        for i in xrange(len(self._lineControlPoints) - 1):
    ...
    def ResetControlPoints(self):
        if self._canvas and self._lineControlPoints and self._controlPoints:
            for i in xrange(min(len(self._controlPoints), len(self._lineControlPoints))):
                point = self._lineControlPoints[i]
