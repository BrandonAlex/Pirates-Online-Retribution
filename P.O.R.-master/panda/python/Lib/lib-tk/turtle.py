...
##        """may be implemented for some other graphics toolkit"""
    ...
    def _pointlist(self, item):
        ...
        pl = [(cl[i], -cl[i+1]) for i in xrange(0, len(cl), 2)]
        return  pl
...
#    _STANDARD_DELAY = 5
    ...
    def colormode(self, cmode=None):
        ...
        r, g, b values of colortriples have to be in xrange 0..cmode.
