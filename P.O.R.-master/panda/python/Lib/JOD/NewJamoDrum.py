...
class JamoDrum(DirectObject):
    ...
    def generateMouseDigest(self):
        m = md5.md5()
        for i in xrange(base.win.getNumInputDevices()):
    ...
    def prepareDevices(self):
        ...
        """
        self.polls = []
        for devindex in xrange(1, base.win.getNumInputDevices()):
            devname = base.win.getInputDeviceName(devindex)
            for devaxis in xrange(2):
