...
class PiratesRPCHandler(PiratesRPCHandlerBase):
    ...
    def rpc_update(self, callback, reason="for an update"):
        """
        Summary:
            Alerts all users of TLOPO shutting down for maintenance with optional [reason].
        """
        message = 'Ahoy, maties! The Legend of Pirates Online will be closing momentarily %s.' % reason
