...
class CannonCamera(CameraMode.CameraMode, NodePath, ParamObj):
    ...
    def popParams(self):
        if (len(self._paramStack) and self._paramStack.pop().applyTo(self)):
            pass
    ...
    def enterActive(self):
        ...
        if (base.wantEnviroDR and base.enviroCamNode.setLodCenter(self)):
            pass
        if (self.cannonProp.ship and self.reparentTo(self.cannonProp.ship.avCannonView)):
            pass
    ...
    def exitActive(self):
        ...
        if (base.wantEnviroDR and base.enviroCamNode.setLodCenter(NodePath())):
            pass
        self.disableInput()
    ...
    def _keyboardUpdateTask(self, task):
        ...
        dx *= dt
        dy *= dt
        self.keyboardDelta = (dx,
         dy)
        if self._CannonCamera__moveCamera(dx, dy):
            pass
        return Task.cont
    ...
    def __moveCamera(self, dx, dy):
        ...
        if ship:
            ...
            self.cannonProp.currentHpr = (newH,
             p,
             0)
        else:
