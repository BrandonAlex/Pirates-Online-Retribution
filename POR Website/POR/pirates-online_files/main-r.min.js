...
////////////////////////////////////////////////////////////////////////
var packagesUtil = new PackagesUtil(["animations","buttonCommon","clipArt","cloud","components","componentsPreviewLayer","core","coreUtils","dataFixer","displayer","documentServices","editingRendererPlugins","fonts","fontsPrefetch","galleriesCommon","image","imageClientApi","imageCommon","layout","loggingUtils","matrixGallery","paginatedGridGallery","pinItPinWidget","popupCloseTextButton","previewExtensionsCore","qaAutomation","render","santaProps","server","siteButton","siteUtils","skins","testUtils","textCommon","tpa","translationsUtils","tweenEngine","utils","wPhoto","wRichText","widgets","wixCode","wixCodeInit","wixSites","wixUrlParser","wixappsBuilder","wixappsClassics","wixappsCore","zoomedImage"], window.location.search);
...
function render(isServerSide, isPreview, contentCache, queryUtil, siteModel, wixBiSession, mobileView, dynamicModelUrl) {
        ...
        requirejs(pkgs, function () {
            ...
            p.zepto(function () {
                if (siteModel.wixData) {
                    var siteStructureNode = document.getElementById('masterPage');
    ...
    function renderClientSide() {
        ...
        var clientSidePackages = ['skins', 'components', 'core', 'fontsPrefetch',
            ...
            // Components
            'paginatedGridGallery', 'matrixGallery', 'galleriesCommon', 'textCommon', 'wPhoto', 'buttonCommon', 'siteButton', 'imageCommon', 'image', 'zoomedImage', 'pinItPinWidget', 'wRichText', 'popupCloseTextButton', 'clipArt'
        ];
