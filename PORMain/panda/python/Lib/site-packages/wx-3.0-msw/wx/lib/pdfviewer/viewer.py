...
#----------------------------------------------------------------------------
    ...
    def Render(self, force=True):
        ...
        if force:
            ...
            for pageno in xrange(self.frompage, self.topage+1):
...
class mupdfProcessor(object):
    ...
    def DrawFile(self, frompage, topage):
        ...
        """  
        for pageno in xrange(frompage, topage+1):
...
class pypdfProcessor(object):
    ...
    def DrawFile(self, frompage, topage):
        ...
        for self.pageno in xrange(frompage, topage+1):
    ...
    def ProcessOperators(self, opslist, pdf_fonts):
        ...
        for k in xrange(len(drawlist)-1):
