...
class LevelEditorUIBase(WxPandaShell):
    ...
    def onKeyEvent(self, evt):
        input = ''
        if evt.GetKeyCode() in xrange(97, 123): # for keys from a to z
