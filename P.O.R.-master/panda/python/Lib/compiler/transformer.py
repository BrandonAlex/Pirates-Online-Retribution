...
class Transformer:
    ...
    def simple_stmt(self, nodelist):
        ...
        stmts = []
        for i in xrange(0, len(nodelist), 2):
    ...
    def expr_stmt(self, nodelist):
        ...
        if nodelist[1][0] == token.EQUAL:
            nodesl = []
            for i in xrange(0, len(nodelist) - 2, 2):
    ...
    def print_stmt(self, nodelist):
        ...
        if len(nodelist) == 1:
            ...
            dest = None
            start = 1
        for i in xrange(start, len(nodelist), 2):
    ...
    def global_stmt(self, nodelist):
        # global: NAME (',' NAME)*
        names = []
        for i in xrange(1, len(nodelist), 2):
    ...
    def if_stmt(self, nodelist):
        ...
        tests = []
        for i in xrange(0, len(nodelist) - 3, 4):
...
##      elseNode.lineno = nodelist[-1][1][2]
    ...
    def comparison(self, nodelist):
        ...
        results = []
        for i in xrange(2, len(nodelist), 2):
            nl = nodelist[i-1]
    ...
    def com_try_except_finally(self, nodelist):
        ...
        elseNode = None
        finallyNode = None
        for i in xrange(3, len(nodelist), 3):
            node = nodelist[i]
    ...
    def com_with(self, nodelist):
        ...
        for i in xrange(len(nodelist) - 3, 0, -2):
    ...
    def com_dictorsetmaker(self, nodelist):
        ...
        if len(nodelist) == 1 or nodelist[1][0] == token.COMMA:
            ...
            # dict literal
            items = []
            for i in xrange(0, len(nodelist), 4):
                items.append((self.com_node(nodelist[i]),
